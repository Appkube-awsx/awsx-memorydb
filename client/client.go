...
import (
	...
	"github.com/Appkube-awsx/awsx-memorydb/awssession"
	"github.com/aws/aws-sdk-go/aws"
	"github.com/aws/aws-sdk-go/service/memorydb"
	"github.com/aws/aws-sdk-go/service/sts"
)

func GetClient(region string, crossAccountRoleArn string, accessKey string,  secretKey string, externalId string) *memorydb.MemoryDB{
...
func assumeRole(roleArn string, sessionName string, accesskey string, secretKey string, region string, externalId string)  *memorydb.MemoryDB {
	...
	clusterClient := memorydb.New(awsSession)
